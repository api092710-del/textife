...
const faqs = [
  { q: 'What is Textife?',                  a: 'Textife is an AI-powered WhatsApp business automation platform. It turns your WhatsApp Business number into a 24/7 intelligent assistant that auto-replies, captures leads, assists with sales, and generates marketing content.' },
  { q: 'Do I need technical skills?',          a: 'Not at all! Textife is designed for business owners, not developers. Our step-by-step setup wizard guides you through everything. You\'ll be up and running in under 30 minutes.' },
